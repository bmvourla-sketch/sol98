...
/**
 * Total SOL to buy `count` blocks in one purchase, with the price stepping up
 * every 10 blocks (see `bulkBlockPrice`). The price steps up once more (+10%)
 * after the whole purchase completes, via the usual per-sale bonding curve.
 */
